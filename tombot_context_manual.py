...
TOPIC_FILES = {
    ...
    "list": "context_list.txt",
    "terrain": "context_terrain.txt",
    "prize": "context_prize.txt",
    "rule": "context_rule.txt",
    "faq": "context_faq.txt",
    "pairing": "context_pairing.txt",
    "player": "context_player.txt",
    "mission": "context_mission.txt",
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Examples:\n"
                    "Q: When is list submission?           → list\n"
                    "Q: When are lists due?                → list\n"
                    "Q: What time do rounds start?         → schedule\n"
                    "Q: Where is the event held?           → venue\n"
                    "Q: Who is the favorite to win today?  → player\n"
